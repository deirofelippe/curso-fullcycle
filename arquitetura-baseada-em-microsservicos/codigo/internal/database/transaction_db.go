...
func (a *TransactionDB) Create(transaction *entity.Transaction) error {
	stmt, err := a.DB.Prepare("INSERT INTO transactions (id, account_id_from, account_id_to, amount, created_at) VALUES (?, ?, ?, ?, ?)")
	if err != nil {
		return err
	}
